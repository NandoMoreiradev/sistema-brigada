...
//
// Sem campo de senha: a senha é gerada aleatoriamente pelo backend e a pessoa
// a define pelo link do e-mail de boas-vindas (ver UsersService.create) — mesmo
// padrão do admin de academia em organizations/dto/create-organization.dto.ts.
